...
<template>
  <q-page class="sectors-page-container">
    <div class="sectors-content">
      <!-- Form Section -->
      <q-card class="sectors-form-card q-mb-md">
        <!-- Header del formulario -->
        <div class="form-header">
          <div class="header-content">
            <q-icon name="location_city" size="md" class="q-mr-sm" />
            <div class="header-text">
              <div class="text-h6">{{ editMode ? 'Editar Sector' : 'Nuevo Sector' }}</div>
              <div class="header-subtitle">Gestión de sectores del acueducto</div>
            </div>
          </div>
        </div>
...
// Card del formulario de sectores
.sectors-form-card {
  border-radius: 16px;
